...
@Data
public class SystemServerInfoVO implements Serializable {
    ...
    private void setSysFiles(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray) {
            ...
            BigDecimal bigDecimalUsed = new BigDecimal(Double.toString(used));
            BigDecimal bigDecimalTotal = new BigDecimal(Double.toString(total));
            BigDecimal result = bigDecimalUsed.divide(bigDecimalTotal, 2, RoundingMode.HALF_UP).multiply(BigDecimal.valueOf(100));
            sysFile.setUsage(result.doubleValue());
