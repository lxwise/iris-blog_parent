...
public class DateUtil {
     ...
     * 仅显示年月，例如 2015-08.
     */
    public static final String YEAR_MOON_DATE_PATTERN = "yyyy-MM";
     ...
     */
    public static String getLocalDateYearMoonStr() {
        return format(LocalDate.now(), YEAR_MOON_DATE_PATTERN);
    }
     ...
     * 获取当前日期和时间字符串(无符号).
     *
     * @return String 日期时间字符串，例如 20150811095153
     */
    public static String getLocalDateTimeUnsignedStr() {
     ...
     */
    public static String getLocalDateUnsignedStr() {
        return format(LocalDate.now(), UNSIGNED_DATE_PATTERN);
    }
    ...
    public static String convertSecondsToHMS(long seconds) {
        ...
        int seconds1 = time.getSecond();
        return String.format("%02d时%02d分%02d秒", hours, minutes, seconds1);
    }
     ...
     * @return
     */
    public static String convertSecondsToMS(long seconds) {
        LocalTime time = LocalTime.ofSecondOfDay(seconds);
        int minutes = time.getMinute();
        int seconds1 = time.getSecond();
        return String.format("%02d分%02d秒", minutes, seconds1);
    }
     ...
     * @return
     */
    public static String convertSecondsToDHMS(Long time) {
        ...
        if (day > 0) {
            return String.format("%02d天%02d时%02d分%02d秒", day, hours, minutes, seconds);
        }
