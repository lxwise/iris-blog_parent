...
import * as RedisApi from '@/api/system/monitor/index'
import { RedisMonitorInfoVO } from '@/api/system/monitor/types'
const cache = ref<RedisMonitorInfoVO>()
import Echart from '@/components/Echart/src/Echart.vue'
// 基本信息
const readRedisInfo = async () => {
  const data = await RedisApi.getSystemCacheInfo()
  cache.value = data
}
