  ...
  <ContentWrap>
    ...
    >
      <el-form-item label="字典类型" prop="dictType">
        <el-input
          v-model="queryParams.action.dictType"
          placeholder="请输入字典类型"
          clearable
      ...
      <el-form-item label="字典名称" prop="dictName">
        <el-input
          v-model="queryParams.action.dictName"
          placeholder="请输入字典名称"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
    ...
    >
      ...
      <el-table-column label="字典类型" align="center" prop="dictType">
        <template #default="scope">
          <router-link :to="'/dict/type/data/' + scope.row.dictType">
            <el-link type="success">{{ scope.row.dictType }}</el-link>
          </router-link>
        </template>
      </el-table-column>
      ...
      <el-table-column :width="300" label="操作" align="center">
        <template #default="scope">
          ...
          <router-link :to="'/dict/type/data/' + scope.row.dictType">
            <el-button link type="primary" class="mr-5px">
...
const handleExport = async () => {
  try {
    ...
    const data = await DictTypeApi.exportDictype(queryParams)
