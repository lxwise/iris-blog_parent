export default {
  ...
  login: {
    ...
    message:
      'Iris blog is a client-side and server-side blog system based on Spring Boot+Vue3 + TypeScript + Vite+JavaFx. The project adopts the separation of front-end and back-end, and the client provides two modes of B-end and C-end, embedded with multiple system themes.',
